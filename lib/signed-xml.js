...
SignedXml.prototype.getKeyInfo = function(prefix) {
  ...
  if (this.keyInfoProvider) {
    res += "<" + currentPrefix + 'KeyInfo Id="KI-' + this.id + '">'
  ...
  for (var n in this.references) {
    ...
    for (var h in nodes) {
      ...
      if (ref.isEmptyUri) {
        ...
        ref.uri = id
        res += "<" + prefix + "Reference URI=\"#id-" + _id + "\">"
      }
      ...
      for (var t in ref.transforms) {
        ...
        res += '<ec:InclusiveNamespaces xmlns:ec="http://www.w3.org/2001/10/xml-exc-c14n#" PrefixList=""/>'
...
SignedXml.prototype.createSignedInfo = function(doc, prefix) {
  ...
  res += "<" + currentPrefix + "CanonicalizationMethod Algorithm=\"" + transform.getAlgorithmName() + "\">" +
         ...
         "</" + currentPrefix + "CanonicalizationMethod>" +
...
SignedXml.prototype.createSignature = function(signedInfo, prefix) {
  ...
  canonizedSignedInfo = canonizedSignedInfo.replace(`<ds:SignedInfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#">`, `<ds:SignedInfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">`);
